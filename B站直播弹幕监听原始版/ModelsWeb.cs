...
#pragma warning disable CS8618 // 非空字段未初始化，保持与 Python 一致

namespace models_web
{
    public static class MessageTypes
    {
        public const int MSG_ENTER = 1;
        public const int MSG_FOLLOW = 2;
        public const int MSG_SHARE = 3;
        public const int MSG_SPECIAL_FOLLOW = 4;
        public const int MSG_MUTUAL_FOLLOW = 5;
        public const int MSG_LIKE = 6;
    }
